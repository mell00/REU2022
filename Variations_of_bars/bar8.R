#complete BAR - Variation 8 (2/2/Random)

bar8 = function(k, time, data, iterations, make, murder){
...
#current_result = bar2(bkpts_2$breakpoints, test_data_2[,1], test_data_2[,2], 50, 0.4, 0.4)
