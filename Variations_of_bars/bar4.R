#complete BAR - Variation 4 (Random/2/Random)

bar4 = function(k, time, data, iterations, make, murder){
  ...
  #this function kills one breakpoint based on scoring
  ...
  barMove0<-function(k_ends){
    ...
    k_ends_less = barMurder2(k_ends) #kills a point
...
current_result = bar4(bkpts_2$breakpoints, test_data_2[,1], test_data_2[,2], 50, 0.4, 0.4)
