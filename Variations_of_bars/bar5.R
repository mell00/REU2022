#complete BAR - Variation 5 (1/1/Random)


bar5 = function(k, time, data, iterations, make, murder){
  ...
  barMove0<-function(k_ends){
    ...
    k_ends_final = barMake1(k_ends_less) #remakes a point
    return(k_ends_final)
