#complete BAR - Variation B (scoring/Random/Move+Jiggle)
...
bar2 = function(k, time, data, iterations, make_murder_p, percent, lambda){
...
current_result = bar2(bkpts_2$breakpoints, test_data_2[,1], test_data_2[,2], 2500, 0.5, 0.02, lambda)
