#complete BAR - Variation B (Random/interval/Move+Jiggle)
...
bar3 = function(k, time, data, iterations, make_murder_p, percent, lambda){
...
#current_result = bar3(bkpts_2$breakpoints, test_data_2[,1], test_data_2[,2], 2500, 0.5, 0.02, lambda)
