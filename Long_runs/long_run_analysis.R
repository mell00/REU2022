...
bar0_data2_bpnocon = readRDS("bar0_data2_bpnoconstraints.RData")
...
acceptrate = cbind(acceptrate_bar0, acceptrate_bar2)
rownames(acceptrate) = c("2bpn", "2bpw", "2mid", "10bpn", "10bpw", "10mid",
"climbpn", "climbpw", "climmid")
colnames(acceptrate) = c("bar0", "bar2")
round(acceptrate, 5)
...
current_title = "bar2_climate_middle"
...
plot_tau_hist(current_sim, current_title, x_label, y_label, bar_color, n_breaks, x_limits, c(y_lower, y_upper))
