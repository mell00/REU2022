...
&= \frac{\Big[ \frac{f(x_1,\dots,x_t | \tau_{n} K_{n}) \pi(\tau_{n} K_{n})}{\int f(x_1, \dots ,x_t | \tau_{n} K_{n}) \pi(\tau_{n} K_{n}) d \tau_{n} K_{n} } \Big] q(\tau_{o} K_{o} | \tau_{n} K_{n})}{\Big[ \frac{f(x_1,\dots,x_t | \tau_{o} K_{o}) \pi(\tau_{o} K_{o})}{\int f(x_1, \dots ,x_t | \tau_{o} K_{o}) \pi(\tau_{o} K_{o}) d \tau_{o} K_{o} }\Big] q(\tau_{n} K_{n}| \tau_{o} K_{o})} 
\end{align*}

Then we have,
\begin{align*}
ratio &= \frac{\Big[ \frac{ \int f(x_1,\dots,x_t | \tau_{n} K_{n}) \big(\pi(\tau|K)\pi(K)\pi(\beta)\pi(\sigma)\big) d\tau dK }{\int f(x_1, \dots ,x_t | \tau_{n} K_{n}) \big(\pi(\tau|K)\pi(K)\pi(\beta)\pi(\sigma)\big) d\tau dK d \beta d\sigma } \Big] q(\tau_{o} K_{o} | \tau_{n} K_{n})}{\Big[ \frac{ \int f(x_1,\dots,x_t | \tau_{o} K_{o}) \big(\pi(\tau|K)\pi(K)\pi(\beta)\pi(\sigma)\big) d\tau dK}{\int f(x_1, \dots ,x_t | \tau_{o} K_{o}) \big(\pi(\tau|K)\pi(K)\pi(\beta)\pi(\sigma)\big) d \tau dK d \beta d\sigma }\Big] q(\tau_{n} K_{n}| \tau_{o} K_{o})} 
\end{align*}

Basing priors of the  paper written by Kass, DiMatteo, and Genovese (2001) 
...
& \ …
\end{align*}
As proved by Kass \& Wasserman (1995), the log of the Bayes Factor can be approximated with BIC with an error on the order of $O(n^{-1/2})$ when the data size is greater than 25 and the prior follows a normal distribution.
Therefore, 
\begin{align*}
...
\end{align*}
When the chosen MCMC step is subtraction,  \begin{align*}
