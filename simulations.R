...
simulation = function(data_fun, runs, iterations, current_bar, make, lambda){
	...
	for(i in 1:runs){
		...
		current_result = current_bar(starting_breakpoints, current_data[,1], current_data[,2], iterations, make, lambda)
...
sim_list = simulation(data_fun, runs, iterations, current_bar, make, lambda)
