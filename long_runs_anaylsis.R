...
#mCbar0_bp
plot(bar0_climate_bpconstraints$MSE[,1], ylab = "MSE", xlab="Number of Iterations")
#mCbar0_bpno
plot(bar0_climate_bpnoconstraints$MSE[,1], ylab = "MSE", xlab="Number of Iterations")
#mCbar0_mid
plot(bar0_climate_middle$MSE[,1], ylab = "MSE", xlab="Number of Iterations")

#m10bar0_bp
plot(bar0_data10_bpconstraints$MSE[,1], ylab = "MSE", xlab="Number of Iterations")
#m10bar0_bpno 
plot(bar0_data10_bpnoconstraints$MSE[,1], ylab = "MSE", xlab="Number of Iterations")
#m10bar0_mid 
plot(bar0_data10_middle$MSE[,1], ylab = "MSE", xlab="Number of Iterations")

#m2bar0_bp 
plot(bar0_data2_bpconstraints$MSE[,1], ylab = "MSE", xlab="Number of Iterations")
#m2bar0_bpno 
plot(bar0_data2_bpnoconstraints$MSE[,1], ylab = "MSE", xlab="Number of Iterations")
#m2bar0_mid 
plot(bar0_data2_middle$MSE[,1], ylab = "MSE", xlab="Number of Iterations")


#bar1

#mCbar1_bp 
plot(bar1_climate_bpconstraints$MSE[,1], ylab = "MSE", xlab="Number of Iterations")
#mCbar1_bpno
plot(bar1_climate_bpnoconstraints$MSE[,1], ylab = "MSE", xlab="Number of Iterations")
#mCbar1_mid 
plot(bar1_climate_middle$MSE[,1], ylab = "MSE", xlab="Number of Iterations")

#m10bar1_bp 
plot(bar1_data10_bpconstraints$MSE[,1], ylab = "MSE", xlab="Number of Iterations")
#m10bar1_bpno 
plot(bar1_data10_bpnoconstraints$MSE[,1], ylab = "MSE", xlab="Number of Iterations")
#m10bar1_mid
plot(bar1_data10_middle$MSE[,1], ylab = "MSE", xlab="Number of Iterations")

#m2bar1_bp 
plot(bar1_data2_bpconstraints$MSE[,1], ylab = "MSE", xlab="Number of Iterations")
#m2bar1_bpno
plot(bar1_data2_bpnoconstraints$MSE[,1], ylab = "MSE", xlab="Number of Iterations")
#m2bar1_mid 
plot(bar1_data2_middle$MSE[,1], ylab = "MSE", xlab="Number of Iterations")

#bar2

#mCbar2_bp
plot(bar2_climate_bpconstraints$MSE[,1], ylab = "MSE", xlab="Number of Iterations")
#mCbar2_bpno
plot(bar2_climate_bpnoconstraints$MSE[,1], ylab = "MSE", xlab="Number of Iterations")
#mCbar2_mid
plot(bar2_climate_middle$MSE[,1], ylab = "MSE", xlab="Number of Iterations")

#m10bar2_bp 
plot(bar2_data10_bpconstraints$MSE[,1], ylab = "MSE", xlab="Number of Iterations")
#m10bar2_bpno 
plot(bar2_data10_bpnoconstraints$MSE[,1], ylab = "MSE", xlab="Number of Iterations")
#m10bar2_mid 
plot(bar2_data10_middle$MSE[,1], ylab = "MSE", xlab="Number of Iterations")

#m2bar2_bp
plot(bar2_data2_bpconstraints$MSE[,1], ylab = "MSE", xlab="Number of Iterations")
#m2bar2_bpno
plot(bar2_data2_bpnoconstraints$MSE[,1], ylab = "MSE", xlab="Number of Iterations")
#m2bar2_mid 
plot(bar2_data2_middle$MSE[,1], ylab = "MSE", xlab="Number of Iterations")
